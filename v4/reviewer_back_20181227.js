                    ...
                    if((snap != '') && (snap.length > 0)){
                      ...
                      snap.forEach(function(childSnap){
                        ...
                        var data2 = '<tr>' +
                                      ...
                                      '<td>' +
                                        '<a class="btn btn-block btn-danger btn-sm" id="btnDeleteReply" href="Javascript:deleteAssesmentReply(' + childSnap.rfa_id + ')" target="_blank"><i class="fas fa-trash text-light mr-5"></i> <span class="hidden-sm">ลบไฟล์</span></a>' +
                                      '</td>' +
                                    '</tr>'
                        ...
                        if((childSnap.fid == '2') || (childSnap.fid == '3') || (childSnap.fid == '4') || (childSnap.fid == '8') || (childSnap.fid == '9') || (childSnap.fid == '10') || (childSnap.fid == '11') || (childSnap.fid == '12') || (childSnap.fid == '13')){
                          ...
                          $data_assesment = '<tr>' +
                                    ...
                                    '<td class="text-center">' +
                                      '<button class="btn btn-success btn-lg_ btn-block btn-sm_ mr-5" onclick="doEform(' + childSnap.fid + ')"><i class="fas fa-pencil-alt"></i> ทำแบบประเมิน</button>' +
                                    '</td>' +
                                  '</tr>'
