var rs_comment = {
  get_org_comment: function(){
    var param = {
      id_rs: current_rs_id
    }

    var jxr = $.post(ws_url + 'controller/get_org_comment.php', param, function(){}, 'json')
                 ...
                 if((snap != '') && (snap.length > 0)){
                   ...
                   snap.forEach(function(i){
                     if(i.riwc_part == '1'){
                       ...
                       $data = '<div class="row">' +
                                  '<div class="col-md-3"><b>ประเด็นคำถาม : </b></div>' +
                                  '<div class="col-md-9"><span class="q_id_' + i.riwc_id + '">NA</span></div>' +
