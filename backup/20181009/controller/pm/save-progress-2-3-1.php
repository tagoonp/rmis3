...
$rp2_title_th = mysqli_real_escape_string($conn, $_POST['rp2_title_th']);
$rp2_title_en = mysqli_real_escape_string($conn, $_POST['rp2_title_en']);
...
if($status == 'draft'){
  ...
  $strSQL = "DELETE FROM rec_progress_2 WHERE rp2_key = '$rp2_key' AND rp2_t1type = '$rp2_t1type' AND rp2_id_rs = '$id_rs' AND rp2_conf = '0'";
  mysqli_query($conn, $strSQL);

  if($rp2_t1type == '3'){
    $strSQL = "INSERT INTO rec_progress_2 (rp2_key, rp2_t1type, rp2_year, rp2_title_th, rp2_title_en, rp2_t2, rp2_t2info, rp2_t3, rp2_t3a, rp2_t3b, rp2_t3c,
              rp2_t3d, rp2_t3e, rp2_t3f, rp2_t3g, rp2_t4, rp2_t5, rp2_t6, rp2_adddate, rp2_id_rs, rp2_status, rp_2_user)
              VALUES ('$rp2_key', '$rp2_t1type', '$rp2_y', '$rp2_title_th', '$rp2_title_en', '$rp2_t2', '$rp2_t2info', '$rp2_t3',
              '$rp2_t3a', '$rp2_t3b', '$rp2_t3c', '$rp2_t3d', '$rp2_t3e', '$rp2_t3f', '$rp2_t3g', '$rp2_t4', '$rp2_t5', '$rp2_t6', '$date', '$id_rs', '$status', '$user')";
    if($query = mysqli_query($conn, $strSQL)){
        echo "Y";
        $strSQL = "INSERT INTO log_research (log_activity, log_detail, log_datetime, log_view, id_rs, log_by) VALUES ('Save amendment record as $status', 'ผู้วิจัยบันทึกแบบขอปรับปรุงโครการฉบับร่าง โครงการ $id_rs', '$date', '0', '$rp2_key', 'PM : ".$user."')";
        mysqli_query($conn, $strSQL);
    }else{
        echo $strSQL;
    }
