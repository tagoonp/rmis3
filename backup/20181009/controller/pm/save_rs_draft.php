...
// $other_funds = mysqli_real_escape_string($conn, $_POST['other_funds']);
...
if($query){
  ...
  if($rn == 0){
    $strSQL = "INSERT INTO research (id_lrRec, ep, id_pm, id_year, id_dept, id_personnel, title_th, title_en,
              ...
              source_funds, brief_reports, id_status_research, code_apdu, ip_add, date_submit,
              ...
              '$source_funds', '$brief_reports', '1', '', '$ip_add', '$date', '$cotype', '', '$yid_tmp', '1', '$sess_id'
            )";
    ...
    $strSQL = "UPDATE research SET
              ...
              cotype = '$cotype',
              id_adv = ''
              WHERE id_pm = '$id_pm' AND session_id = '$sess_id'
              ";
    if($query = mysqli_query($conn, $strSQL)){
      echo "Y";
