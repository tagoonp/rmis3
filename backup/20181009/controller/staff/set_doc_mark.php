...
if($query = mysqli_query($conn, $strSQL)){
  ...
  // Update 20180815 : Tagoon
  $strSQL = "INSERT INTO research_new_progress (rwp_title, rwp_info, rwp_id_rs, rwp_datetime, rwp_notify_by) VALUES ('โครงการรอสรุปข้อเสนอแนะ', '<p>[System] - โครงการรอสรุปข้อเสนอแนะ</p>', '$id_rs', '$date', '$id') ";
  mysqli_query($conn, $strSQL);
}
