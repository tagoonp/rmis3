...
<html>
    ...
    <body>
      ...
      if((isset($_GET['id_rs']))){
        ...
        $detail = "ผู้ทรงคุณวุฒิยินดีพิจารณาโครงการวิจัย (Researh_id: ".$_GET["id_rs"].") โดยผู้ทรง (ID : ".$_SESSION['id'].")";
      ...
      swal({
        ...
        text: "ท่านได้ตอบรับเพื่อเป็นผู้ทรงคุณวุฒิในการพิจารณาโครงการวิจัย กดปุ่มถัดไป เพื่อเข้าสู่ระบบ!",
        type: "success",
      ...
      function(){
        window.location = './comment_add.php?id_rs=<?php echo $_GET['id_rs'];?>';
      });
      </script>
