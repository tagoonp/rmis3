...
$strSQL = "SELECT * FROM dis_approve_project WHERE dis_id_rs = '$id_rs' AND dis_stage = 'first' AND dis_status = '1'";
...
if(($result) && (mysqli_num_rows($result) > 0)){
  $strSQL = "SELECT * FROM research a
            ...
            LEFT JOIN research_assign_fullboard_agendar j ON a.id_rs = j.rafa_id_rs
            WHERE a.id_rs = '$id_rs'
  ...
  $strSQL = "SELECT * FROM research a
            ...
            LEFT JOIN research_consider_type i ON a.id_rs = i.rct_id_rs
            LEFT JOIN research_assign_fullboard_agendar j ON a.id_rs = j.rafa_id_rs
            LEFT JOIN $doc_table k ON a.id_rs = k.rai_id_rs
