...
$rw_label = mysqli_real_escape_string($conn, $_POST['rw_label']);

$strSQL = "UPDATE research_init_reviewer SET rir_binding_label = '$rw_label' WHERE rir_id = '$ririd'";
...
if(isset($_POST['file13'])){
  if($_POST['file13'] != '0'){
    $strSQL = "INSERT INTO research_init_reviewer_file_attached (rif_fileid, rif_rir_id, rif_adddatetime, rif_addby)
              VALUES ('".$_POST['file13']."', '$ririd', '".date('Y-m-d H:i:s')."', '$id')
              ";
    mysqli_query($conn, $strSQL);
  }
}
