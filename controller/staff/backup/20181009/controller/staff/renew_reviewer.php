...
if($query = mysqli_query($conn, $strSQL)){
  ...
  $strSQL = "INSERT INTO log_note (log_activity, log_detail, log_ip, log_datetime, log_id_rs, log_by_role, log_by_id ) VALUES ('Add note', '<p>[System] เจ้าหน้าเลขา EC เพื่อดำเนินการเลือกผู้เชี่ยวชาญอิสระใหม่/เพิ่มเติม</p>$msg', '$ip_add', '$date', '$id_rs', 'staff', '$id')";
  mysqli_query($conn, $strSQL);
