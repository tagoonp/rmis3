...
if($query = mysqli_query($conn, $strSQL)){
  ...
  $strSQL = "INSERT INTO log_note (log_activity, log_detail, log_ip, log_datetime, log_id_rs, log_by_role, log_by_id ) VALUES ('Add note', '<p>[System] ส่งแบบประเมินให้ผู้เชี่ยวชาญอิสระ (REVIEWER_ID : ".$rir_id.")</p>', '$ip_add', '$date', '".$row['rir_id_rs']."', 'staff', '$id')";
  mysqli_query($conn, $strSQL);
