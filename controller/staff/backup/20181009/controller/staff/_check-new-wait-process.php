...
$strSQL = "SELECT * FROM research a INNER JOIN type_research b ON a.id_type  = b.id_type
          ...
          WHERE
            ...
            -- AND a.id_rs IN (SELECT rwp_id_rs FROM research_new_progress xa INNER JOIN research xb ON xa.rwp_id_rs = xb.id_rs WHERE xa.rwp_status = '0' AND xb.id_status_research = '5')
