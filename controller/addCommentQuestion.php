...
if($id_part == 1){
  ...
  $strSQL = "INSERT INTO research_init_rw_comment (riwc_seq, riwc_part, riwc_q, riwc_staff_add_date, riwc_staff_id, riwc_id_rs, riwc_extra_label)
            VALUES ('$new_seq', '$id_part', '$data', '$date', '$id_user','$id_rs', '$source')";
  $query = mysqli_query($conn, $strSQL);
