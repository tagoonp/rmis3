...
if($query){
  ...
  if($nrow > 0){
    ...
    $strSQL = "INSERT INTO eform_icf (efi_gc, efi_1, efi_2, efi_3, efi_4, efi_5,
              ...
              , efi_17, efi_18, efi_19, efi_20, efi_21, efi_22, efi_23, efi_42, efi_42_comment, efi_status, efi_udate, efi_reviewer_id, efi_id_rs)
              ...
              , '$efb_21', '$efb_22', '$efb_23', '$efb_42', '$efb_42_comment', 'draft', '$date', '$id_reviewer', '$id_rs'
            )";
