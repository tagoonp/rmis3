...
if($query){
  ...
  if($nrow > 0){
    ...
    $strSQL = "INSERT INTO eform_social_comment (cfsc_comment, cfsc_title, cfsc_element, cfsc_efb_id, cfsc_udate)
              VALUES ('$comment', '$comment_title', '$element', '".$data['efs_id']."', '$date')
              ";
