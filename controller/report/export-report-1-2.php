...
$strSQL = "SELECT * FROM research a INNER JOIN useraccount b ON a.id_pm = b.id_pm
          ...
          if($query = mysqli_query($conn, $strSQL)){
            ...
            echo '<tr><td colspan=2 style="text-align: center;"><h4 class="text-center">วาระ 3.4 โครงการวิจัยใหม่ที่เข้าข่ายการพิจารณาแบบเร็ว (Expedited Review)<br><small>วันที่ประชุม : <span id="rafa_date"></span></small></h4></td>';
            echo "</tr>";
