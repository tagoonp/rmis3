  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 pb-20">
            <button class="btn btn-success" onclick="window.history.back()"><i class="fas fa-home mr-10"></i>กลับสู่หน้าหลักเพื่อประเมินโครงการ</button>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        // gc_bio = CKEDITOR.replace( 'q_generalcomment_bio', { height: '150px' });
        // notfin_info  = CKEDITOR.replace( 'q_generalcomment_notfit', { height: '150px' });
