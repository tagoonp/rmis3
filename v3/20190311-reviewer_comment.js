  ...
  loadComment: function(j){
    ...
    var jxhr = $.post(ws_url + 'controller/readCommentQuestion.php', param, function(){}, 'json')
                .always(function(snap){
                  ...
                  // console.log(snap.length + ' from part -> ' + j);
                  ...
                  if((snap != '') && (snap.length > 0)){
                    ...
                    // if(j == 2){
                    //   $checkString = $('#p' + j).html().replace(/\s/g, '')
                    //   console.log($checkString);
                    //   if($checkString == '<tr><tdcolspan="2">ไม่มีข้อมูล</td></tr>'){
                    //     console.log('aaa');
                    //   }
                    // }
