                     ...
                     snap.forEach(function(i){
                       ...
                       if(code == ''){
                         if(i.ord_id == ''){
                           ...
                           code = '<div style="font-size: 0.8em;" class="txt-danger">ยังไม่ได้รับการตรวจสอบจากเจ้าหน้าที่</div>'
                         }
                       }
                       ...
                       $link = '<a href="#" onclick=update_draft("' + i.id_rs +'") data-toggle="tooltip" data-placement="top" title="แก้ไขรายงาน" class="txt-success ' + st + '"><i class="zmdi zmdi-edit"></i> แก้ไขข้อเสนอโครงการวิจัย </a> ' +
...
function  checkWithdrawStatus(status, id_rs){
