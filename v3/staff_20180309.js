                ...
                .always(function(snap){
                  ...
                  if((snap!='') && (snap.length > 0)){
                    snap.forEach(function(i){
                      ...
                      // console.log(i.dept);
                      if(i.id_dept == '19'){
                        // var s = i.dept.toString().trim()
                        // s = s.replace("\007C\00a0\00a0", "&nbsp;");

                        // console.log(s);
                        // $dn = i.dept.split(' ')
                        // $dn.forEach(function(dd){
                        //   console.log(dd);
                        // })

                        // for (var ii = 0; ii < s.length; ii++) {
                        //   if(s.charAt(ii) == "\007C\00a0\00a0"){
                        //     console.log('sdasd');
                        //   }else{
                        //     console.log(s.charAt(ii));
                        //   }
                        // }
                        //
                        // console.log(s);
                        ...
                        // $dn = i.dept.split('&nbsp;')
                        // if($dn.length > 0){
                        //   $('#txtPiDept').html($dn.join('&nbsp;'))
                        // }else{
                        //   $('#txtPiDept').html(i.dept)
                        // }
                      }else{
                            ...
                            .always(function(snap){
                              ...
                              if((snap.length > 0) && (snap != '')){
                                ...
                                snap.forEach(function(i){
                                  ...
                                  // console.log(i.co_fname);

                                  $('.subPiDiv').append('<div class="row pb-10">' +
                                    '<div class="col-xs-3 f500">ผู้ร่วมวิจัย: </div>' +
                                    '<div class="col-xs-4">' + i.co_fname + ' ' + i.co_lname + '</div>' +
                                    '<div class="col-xs-5"><span class="f500">สังกัด :</span> <span id="txtPiDept" class="txt-danger">' + i.co_dept + '</span></div>' +
                                  '</div>')
