...
<html>
    ...
    <body>
      ...
      if((isset($_GET['id_rs'])) && (isset($_GET['sid']))){
        $strSQL = sprintf("UPDATE submit_feedback SET status_review = '%s', date_fb = '%s', date_review = '%s' WHERE id_rs = '%s' AND sid = '%s'",
        ...
        $detail = "ผู้ทรงคุณวุฒิไม่ขอพิจารณาโครงการวิจัย (Researh_id: ".$_GET["id_rs"].") โดยผู้ทรง (ID : ".$_SESSION['id'].")";
      ...
      swal({
        ...
        text: "ท่านได้เลือกไม่ขอพิจารณาโครงการวิจัยเรียบร้อยแล้ว!",
        type: "success",
